      ...
      <form onSubmit={handleSubmit} className="pt-3 border-t border-gray-200">
        <div className="flex gap-2">
          <input
            ...
            placeholder={isStreaming ? '응답 생성 중... 다음 메시지를 미리 입력하세요' : (placeholder || '메시지를 입력하세요...')}
          ...
          <button
            ...
            className="px-4 py-2.5 bg-emerald-600 text-white rounded-xl text-sm font-medium hover:bg-emerald-700 disabled:opacity-50 transition-colors"
          >
            {isStreaming ? '...' : '전송'}
          </button>
        </div>
