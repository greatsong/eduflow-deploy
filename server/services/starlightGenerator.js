...
function buildCustomCss({ accentColor = '#0EA5E9', accentBg = '#E0F2FE' }) {
  ...
  return [
    ...
    '}',
    '',
    '/* Mermaid 로딩/방어 — JS가 실행되기 전 또는 CDN 로드 실패 시',
    '   소스 텍스트가 노출되지 않도록 플레이스홀더로 덮는다.',
    '   정상 렌더 완료 시 pre.mermaid는 div.ef-mermaid로 교체되어 이 규칙이 적용되지 않는다. */',
    'pre.mermaid {',
    '  position: relative;',
    '  min-height: 72px;',
    '  margin: 1.6rem 0;',
    ...
    '  display: grid;',
    '  place-items: center;',
    '  color: var(--sl-color-text, #64748b);',
